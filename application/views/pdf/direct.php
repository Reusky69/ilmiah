								...
								<div class="table-responsive">
									<table id="data" class="table table-striped table-bordered" style="width:100%">
										...
										<tbody>
											...
											<?php $i=1; ?>
											<?php foreach($directorate as $c) : ?>
											<tr>
												<th scope="row"><?= $i;?></th>
												<td><?= $c['directorate_name']; ?></td>
												<td><?= $c['company_name']; ?></td>
												<td>
													<a href="<?= base_url('admin/directorate_edit/')?>?id=<?php echo $c['id_directorate']; ?>"
														class="btn btn-circle btn-warning btn-sm"><i
															class="fa fa-edit"></i></a>
													<a onclick="return confirm('Yakin ingin hapus?')"
														href="<?= base_url('admin/directorate_delete/') . $c['id_directorate'] ?>"
